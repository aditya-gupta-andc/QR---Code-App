/* import 'package:demo1/Student/class(Student)/StudentClassDashboard.dart';
...
class StudentAttendanceView extends StatelessWidget {
  ...
  StudentAttendanceView({required this.attendance, required this.classData});

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Attendance: ${classData['class_code']}'), // Safely accessing classData
      ),
      drawer: Drawer(
        child: ListView(
          ...
          children: <Widget>[
            ...
            ListTile(
              ...
              onTap: () {
                Navigator.pop(context); // Close the drawer if already on Attendance page
              },
            ),
          ],
        ),
